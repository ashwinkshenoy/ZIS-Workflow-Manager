...
export function DeleteNodeDialog({ isOpen, onClose, onConfirm, nodeId }: DeleteNodeDialogProps) {
    ...
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            You are about to delete the state <span className='font-semibold text-foreground'>{nodeId}</span>. This
        ...
        <div className='rounded-md border border-amber-500/50 bg-amber-500/10 p-4 text-sm text-amber-700 dark:text-amber-400'>
          <div className='flex items-start gap-3'>
            ...
            <div>
              ...
              <p>
                Deleting this state will automatically attempt to re-wire the workflow. Please review the connections
